/*columns
[
{"name":"CREATED_WHEN", "title":"Date and time", "componentName":"TimestampFromInstant"}
,{"name":"VALUE", "title":"Result", "componentName":"BooleanPassFail"}
]
columns*/

select a.CREATED_WHEN, passed.VALUE
from NODE p
