...
public class MovesBuilderTest {
    ...
    @Test public void test_blackPawnTurnsIntoAnotherPiece() {
        ...
        assertBoardsEqual(chessBoardView(b -> b
                ...
                .__(a6).__(b6).__(c6).__(d6).__(e6).__(f6).__(g6).__(h6)
                .__(a5).__(b5).__(c5).__(d5).__(e5).__(f5).__(g5).__(h5)
                .__(a4).__(b4).__(c4).__(d4)._P(e4).bn(f4).__(g4).__(h4)
                .__(a3).__(b3).__(c3).__(d3).__(e3).bb(f3).__(g3).__(h3)
                .__(a2).__(b2).__(c2).__(d2).__(e2).br(f2).__(g2).__(h2)
    ...
    @Test public void test_choseChessmanTypeDialogIsOpened_noMovesAreAccepted() {
        ...
        assertBoardsEqual(chessBoardView(b -> b
                ...
                .__(a6).__(b6).__(c6).__(d6).__(e6).__(f6).__(g6).__(h6)
                .__(a5).__(b5).__(c5).__(d5).__(e5).__(f5).__(g5).__(h5)
                .__(a4).__(b4).__(c4).__(d4).__(e4).bn(f4).__(g4).__(h4)
                .__(a3).__(b3).__(c3).__(d3).__(e3).bb(f3).__(g3).__(h3)
                .__(a2).__(b2).__(c2).__(d2)._P(e2).br(f2).__(g2).__(h2)
                .__(a1).__(b1).__(c1).__(d1).__(e1).bq(f1).__(g1).__(h1)
        ), view.getChessBoard());
    ...
    @Test public void thePgnProducedByMovesBuilderIsParsableByPgnParserInCaseWhitesMoveWasLast() {
        //given
        MovesBuilder movesBuilder = new MovesBuilder(null, initialPosition(BLACK, b->b
                .K(a8)._(b8)._(c8)._(d8)._(e8)._(f8)._(g8)._(h8)
                ._(a7)._(b7)._(c7)._(d7)._(e7)._(f7)._(g7)._(h7)
    ...
    @Test public void itIsPossibleToPassSequenceSuccessfulyInPracticeMode() {
        //given
        ...
        ChessComponentView view = chessManager.loadFromPgn(
                ...
                ChessComponentStage.PRACTISE_SEQUENCE
        );
        assertEqualsByChessmenTypes(chessBoardBuilder()
                ._(a8)._(b8)._(c8)._(d8)._(e8)._(f8)._(g8)._(h8)
